...
/**
 * &lt;p&gt;UFIDA.U9.Base.FlexField.KeyFlexField.CrossValidateRuleData complex type的 Java 类。
 * 
 * &lt;p&gt;以下模式片段指定包含在此类中的预期内容。
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="UFIDA.U9.Base.FlexField.KeyFlexField.CrossValidateRuleData"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 ...
 *         &amp;lt;element name="m_ruleLines" type="{http://www.UFIDA.org/EntityData}ArrayOfUFIDA.U9.Base.FlexField.KeyFlexField.CrossValidateRuleLineData" minOccurs="0"/&amp;gt;
...
@XmlType(name = "UFIDA.U9.Base.FlexField.KeyFlexField.CrossValidateRuleData", propOrder = {
...
public class UFIDAU9BaseFlexFieldKeyFlexFieldCrossValidateRuleData
    extends UFSoftUBFBusinessDataTransObjectBase
{
    ...
    @XmlElementRef(name = "m_ruleLines", namespace = "http://www.UFIDA.org/EntityData", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfUFIDAU9BaseFlexFieldKeyFlexFieldCrossValidateRuleLineData> mRuleLines;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ArrayOfUFIDAU9BaseFlexFieldKeyFlexFieldCrossValidateRuleLineData }{@code >}
     *     
     */
    public JAXBElement<ArrayOfUFIDAU9BaseFlexFieldKeyFlexFieldCrossValidateRuleLineData> getMRuleLines() {
        return mRuleLines;
    }
     ...
     *     
     */
    public void setMRuleLines(JAXBElement<ArrayOfUFIDAU9BaseFlexFieldKeyFlexFieldCrossValidateRuleLineData> value) {
        this.mRuleLines = value;
    }
