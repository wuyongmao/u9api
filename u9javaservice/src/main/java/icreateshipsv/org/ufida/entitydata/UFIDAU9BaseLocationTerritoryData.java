...
/**
 * &lt;p&gt;UFIDA.U9.Base.Location.TerritoryData complex type的 Java 类。
 * 
 * &lt;p&gt;以下模式片段指定包含在此类中的预期内容。
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="UFIDA.U9.Base.Location.TerritoryData"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
...
@XmlType(name = "UFIDA.U9.Base.Location.TerritoryData", propOrder = {
    "combineName",
    "country",
    "countrySKey",
    "description",
...
public class UFIDAU9BaseLocationTerritoryData
