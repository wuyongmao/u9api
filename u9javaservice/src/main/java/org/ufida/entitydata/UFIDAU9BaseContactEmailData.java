...
/**
 * &lt;p&gt;UFIDA.U9.Base.Contact.EmailData complex type的 Java 类。
 * 
 * &lt;p&gt;以下模式片段指定包含在此类中的预期内容。
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="UFIDA.U9.Base.Contact.EmailData"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 ...
 *         &amp;lt;element name="m_emailAddr" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&amp;gt;
...
@XmlType(name = "UFIDA.U9.Base.Contact.EmailData", propOrder = {
    "contactSKey",
    "mContact",
    "mCreatedBy",
    "mCreatedOn",
...
public class UFIDAU9BaseContactEmailData
    extends UFSoftUBFBusinessDataTransObjectBase
{
    ...
    @XmlElementRef(name = "m_emailAddr", namespace = "http://www.UFIDA.org/EntityData", type = JAXBElement.class, required = false)
    protected JAXBElement<String> mEmailAddr;
     ...
     *     
     */
    public JAXBElement<String> getMEmailAddr() {
        return mEmailAddr;
    }
     ...
     *     
     */
    public void setMEmailAddr(JAXBElement<String> value) {
        this.mEmailAddr = value;
    }
