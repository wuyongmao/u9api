...
/**
 * &lt;p&gt;UFIDA.U9.CBO.FI.ConfirmTerm.APAccrueTermData complex type的 Java 类。
 * 
 * &lt;p&gt;以下模式片段指定包含在此类中的预期内容。
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="UFIDA.U9.CBO.FI.ConfirmTerm.APAccrueTermData"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 ...
 *         &amp;lt;element name="m_payConfirmTime" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&amp;gt;
...
@XmlType(name = "UFIDA.U9.CBO.FI.ConfirmTerm.APAccrueTermData", propOrder = {
    "currency",
    "currencySKey",
    "description",
    "masterOrg",
...
public class UFIDAU9CBOFIConfirmTermAPAccrueTermData
    extends UFSoftUBFBusinessDataTransObjectBase
{
    ...
    @XmlElement(name = "m_payConfirmTime")
    protected Integer mPayConfirmTime;
     ...
     *     
     */
    public Integer getMPayConfirmTime() {
        return mPayConfirmTime;
    }

    /**
     * 设置mPayConfirmTime属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link Integer }
     *     
     */
    public void setMPayConfirmTime(Integer value) {
        this.mPayConfirmTime = value;
    }
