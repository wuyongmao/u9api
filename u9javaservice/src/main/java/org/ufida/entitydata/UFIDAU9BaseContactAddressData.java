...
/**
 * &lt;p&gt;UFIDA.U9.Base.Contact.AddressData complex type的 Java 类。
 * 
 * &lt;p&gt;以下模式片段指定包含在此类中的预期内容。
 * 
 * &lt;pre&gt;
 * &amp;lt;complexType name="UFIDA.U9.Base.Contact.AddressData"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
...
@XmlType(name = "UFIDA.U9.Base.Contact.AddressData", propOrder = {
    "contactSKey",
    "location",
    "locationSKey",
    "mContact",
...
public class UFIDAU9BaseContactAddressData
